...
const AssessmentReset: React.FC<IAssessmentReset> = ({ result, setResult, mutate }) => {
  ...
  return (
    <div>
      ...
      >
        <Modal.Body>
          <h5 className="m-0 p-0 mb-3">Edit assessment allocation</h5>

          <div>
            <h5 className="tw-text-blue-500">
              Are you sure you want to change the scheduled Date of the assessment.
            </h5>
            ...
            <div className="tw-flex tw-justify-end tw-items-center tw-w-full tw-gap-3">
              ...
              <Button
                ...
                disabled={buttonLoader}
              >
                {buttonLoader ? `Rescheduling...` : `Reschedule`}
              </Button>
            </div>
          </div>
        </Modal.Body>
