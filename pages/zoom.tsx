                            ...
                            <tr key={index + "zoomKeys"}>
                              ...
                              <td className="text-center">
                                {key.data && key.data.start_url ? (
                                  <a href={key.data.start_url} target="_blank" rel="noreferrer">
                              ...
                              <td className="text-center">
                                {key.data && key.data.join_url ? (
                                  <a href={key.data.join_url} target="_blank" rel="noreferrer">
                                    <Link style={{ width: "20px" }}></Link>
                                  </a>
                                ) : (
                                  "-"
                              ...
                              <td>
                                {key.data && key.data.end_time
                                  ? datePreview(key.data.end_time)
                                  : "-"}
                              </td>
