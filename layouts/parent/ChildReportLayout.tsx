...
const ReportLayout = ({ children, student, product, mentor }: any) => {
    ...
    let mentorName
    if (mentor) {
        mentorName = mentor.username || mentor.first_name + " " + mentor.last_name
        if (mentor.profile_data) {
            mentorName = mentor.profile_data.name
        }
    }
    return (
        <div className="position-relative">
            ...
            <div className="tw-bg-[#C0405C]  ">
                <div className="md:tw-p-10 lg:tw-p-16 d-flex md:tw-px-[4em] lg:tw-px-[10em]">
                    ...
                    {mentorName && <div className="position-relative  tw-w-fit d-flex align-items-end p-5 py-0 ">
                        <div className="position-relative ">
                            <div className="d-flex justify-content-start align-items-center ">
                                <Image
                                    src={"/bird.svg"}
